    ...
    <div class="d-flex align-items-center logo-box justify-content-center">
        ...
        <a href="index.html" class="logo">
            ...
            <div class="logo-mini w-30">
                ...
                <span class="dark-logo"><img src="{{ asset('dash/images/logo-letter.png') }}" alt="logo"></span>
            </div>
            <div class="logo-lg">
                <span class="light-logo"><img src="{{ asset('dash/images/logo-light-text.png') }}" alt="logo"></span>
