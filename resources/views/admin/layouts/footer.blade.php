<!-- /.content-wrapper -->
  <footer class="main-footer">
    ...
    &copy; {{ date('Y') }} <a href="https://faroukgroup.com/ar">Farouk Group</a>. All Rights Reserved.
</footer>
...
<aside class="control-sidebar">
    ...
    <ul class="nav nav-tabs control-sidebar-tabs">
        <li class="nav-item"><a href="#control-sidebar-home-tab" data-bs-toggle="tab" class=""><i
