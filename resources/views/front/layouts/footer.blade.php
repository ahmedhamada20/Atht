        ...
        <div class="container container--max--xl">
                    ...
                    <div class="footer__widgets">
                        <div class="row g-custom-30 justify-content-between">
                                ...
                                <div class="footer-aboutus">
                                    ...
                                    <ul class="footer-aboutus__contacts">
                                        <li class="footer-aboutus__contacts-item"><a href="#">715 Park Ave,
                                                NY 10021 USA</a></li>
                                        <li class="footer-aboutus__contacts-item"><a
                                                href="#">meblya@example.com</a></li>
                            ...
                            <div class="col-12 col-lg-2 col-sm-6 col-md-3">
                                <div class="footer-links" data-collapse
                                    data-collapse-open-class="footer-links--open" data-collapse-item>
                                    <div class="footer-links__title">
                                        <h4 class="footer-links__header" data-collapse-trigger>Information
                                            <svg class="footer-links__header-arrow" width="9px"
                                                height="6px">
                            ...
                            <div class="col-12 col-lg-2 col-sm-6 col-md-3">
                                <div class="footer-links" data-collapse
                                    ...
                                    <div class="footer-links__content" data-collapse-content>
                                        <ul class="footer-links__list">
                                            <li class="footer-links__item"><a href="#"
                                                    class="footer-links__link">My Account</a></li>
                                            <li class="footer-links__item"><a href="#"
                            ...
                            <div class="col-12 col-lg-4 footer__followus">
                                <div class="footer-followus">
                                    ...
                                    <ul class="footer-followus__social-links">
                                        <li class="footer-followus__social-link"><a
            ...
            <div class="row g-custom-30 justify-content-between">
                <div class="col-12 col-sm-auto">
                    <div class="copyright"><!-- copyright --> <a href="#">Meblya</a> by <a
                            href="#">Kos</a><!-- copyright / end --></div>
                </div>
                <div class="footer__payments col-auto"><img
                        srcset="{{ asset('front/images/payments.png, images/payments@2x.png 2x') }}" src="images/payments.png"
                        alt=""></div>
            </div>
        </div>
    </div>
